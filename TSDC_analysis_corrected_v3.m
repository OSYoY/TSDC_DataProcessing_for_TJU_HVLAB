...
%%%%%%%%%%%%  需要调整的部分  %%%%%%%%%%%%
beta = 0.05;        % 典型升温速率, 0.05 K/s=3 degC/min, 0.0667 K/s=4 degC/min, 0.0833 K/s=5 degC/min
d_sample = 1e-4;    % 样品厚度,单位m
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% 为了捕捉尖峰，我们需要在更密的温度网格上计算理论曲线，然后再插值回实验温度
...
% 输出陷阱能级-密度关系
output_E_density=[Et_array.',N_density_spectrum.'];
writematrix(output_E_density,'陷阱能级-密度.csv');
